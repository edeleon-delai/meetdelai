...
export function Contact() {
  /**
   * mailto: hand-off, exactly as the comp specifies. The launch checklist in
   * /admin tracks replacing this with a real form endpoint + spam protection;
   * until that exists, opening the user's mail client is honest about where
  ...
  function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const subject = `First automation — ${get('company') || get('name')}`;
          ...
          <div className="dl-wrap">
            ...
            >
              ...
              <form id="delai-contact" onSubmit={onSubmit} className="dl-form">
                ...
                <button type="submit" className="dl-btn dl-btn-primary" style={{ justifyContent: 'center', marginTop: 6 }}>
                  Find Your First Automation →
                </button>
                <p style={{ margin: 0, fontSize: 13.5, color: 'var(--dl-faint)', lineHeight: 1.45 }}>
                  Opens your email client with the details filled in. Or write to {contact.email} directly.
                </p>
              </form>
            </div>
          </div>
